...
class RenderableViewManager extends ViewManager<View, LayoutShadowNode> {
    ...
    /* package */ private static final String CLASS_BASE64_IMAGE = "RNSVGBase64Image";
    ...
    static RenderableViewManager createBase64ImageViewManager() {
        return new RenderableViewManager(CLASS_BASE64_IMAGE);
    }
    ...
    public LayoutShadowNode createShadowNodeInstance() {
        switch (mClassName) {
            ...
            case CLASS_BASE64_IMAGE:
                return new Base64ImageShadowNode();
            default:
    ...
    public Class<? extends LayoutShadowNode> getShadowNodeClass() {
        switch (mClassName) {
            ...
            case CLASS_BASE64_IMAGE:
                return Base64ImageShadowNode.class;
            default:
                throw new IllegalStateException("Unexpected type " + mClassName);
        }
    }
